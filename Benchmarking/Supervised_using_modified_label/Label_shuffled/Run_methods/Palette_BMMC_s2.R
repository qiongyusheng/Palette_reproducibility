...
out_dir <- './Benchmarking/Supervised_using_modified_label/Label_shuffled/output/BMMC_s2'
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_shuffled/output/BMMC_s2/meta_34.rds')
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_shuffled/output/BMMC_s2/meta_35.rds')
cellname <- rownames(meta)
meta <- meta[musa_obj@Meta$cell.name,]
all.equal(musa_obj@Meta$cell.name,rownames(meta))
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_shuffled/output/BMMC_s2/meta_36.rds')
cellname <- rownames(meta)
meta <- meta[musa_obj@Meta$cell.name,]
all.equal(musa_obj@Meta$cell.name,rownames(meta))
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_shuffled/output/BMMC_s2/meta_24.rds')
cellname <- rownames(meta)
meta <- meta[musa_obj@Meta$cell.name,]
all.equal(musa_obj@Meta$cell.name,rownames(meta))
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_shuffled/output/BMMC_s2/meta_26.rds')
cellname <- rownames(meta)
meta <- meta[musa_obj@Meta$cell.name,]
all.equal(musa_obj@Meta$cell.name,rownames(meta))
