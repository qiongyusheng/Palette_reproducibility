...
setwd('./Young_Age')
out_dir <- './Benchmarking/Supervised_using_modified_label/Label_shuffled/output/Ab-seq'
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_shuffled/output/Ab-seq/meta_s1.rds')
...
musa_obj <- Add.HVFs(musa_obj,modal = "rna")
musa_obj <- Add.HVFs(musa_obj,modal = "adt")
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_shuffled/output/Ab-seq/meta_s2.rds')
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_shuffled/output/Ab-seq/meta_s3.rds')
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_shuffled/output/Ab-seq/meta.rds')
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_shuffled/output/Ab-seq/meta_s4.rds')
