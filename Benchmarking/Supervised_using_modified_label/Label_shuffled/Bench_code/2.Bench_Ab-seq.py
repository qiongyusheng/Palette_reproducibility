...
data_dir = './Benchmarking/Supervised_using_modified_label/Label_shuffled/output/Ab-seq/'

data_base = ['Palette_s1','Palette_s2','Palette_s3','Palette','Palette_s4']
meta_base = ['meta_s1','meta_s2','meta_s3','meta','meta_s4']
