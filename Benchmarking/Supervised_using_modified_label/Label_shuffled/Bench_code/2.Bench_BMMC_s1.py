...
data_dir = './Benchmarking/Supervised_using_modified_label/Label_shuffled/output/BMMC_s1/'

data_base = ['Palette_drop5','Palette_drop1','Palette_drop6','Palette_drop4','Palette_drop2']
meta_base = ['meta_drop5','meta_drop1','meta_drop6','meta_drop4','meta_drop2']
