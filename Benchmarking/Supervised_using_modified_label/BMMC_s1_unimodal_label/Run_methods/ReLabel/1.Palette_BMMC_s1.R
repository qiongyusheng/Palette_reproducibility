...
mm <- readRDS('./Benchmarking/Supervised_using_modified_label/BMMC_s1_unimodal_label/output/ReLabel/meta_drop5.rds')
mm <- mm[musa_obj@Meta$cell.name,]
musa_obj@Meta[['celltype']] <- mm$predicted.id
...
mm <- readRDS('./Benchmarking/Supervised_using_modified_label/BMMC_s1_unimodal_label/output/ReLabel/meta_drop1.rds')
mm <- mm[musa_obj@Meta$cell.name,]
musa_obj@Meta[['celltype']] <- mm$predicted.id
...
mm <- readRDS('./Benchmarking/Supervised_using_modified_label/BMMC_s1_unimodal_label/output/ReLabel/meta_drop6.rds')
mm <- mm[musa_obj@Meta$cell.name,]
musa_obj@Meta[['celltype']] <- mm$predicted.id
...
musa_obj <- Add.HVFs(musa_obj, modal = "adt")
musa_obj <- Add.HVFs(musa_obj, modal = "atac")
mm <- readRDS('./Benchmarking/Supervised_using_modified_label/BMMC_s1_unimodal_label/output/ReLabel/meta_drop4.rds')
mm <- mm[musa_obj@Meta$cell.name,]
musa_obj@Meta[['celltype']] <- mm$predicted.id
all.equal(musa_obj@Meta$cell.name,mm[,1])
...
mm <- readRDS('./Benchmarking/Supervised_using_modified_label/BMMC_s1_unimodal_label/output/ReLabel/meta_drop2.rds')
mm <- mm[musa_obj@Meta$cell.name,]
musa_obj@Meta[['celltype']] <- mm$predicted.id
