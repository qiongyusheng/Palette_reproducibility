...
data_dir = './Benchmarking/Supervised_using_modified_label/BMMC_s1_unimodal_label/output/Kmeans/'

data_name = ['seurat_Palette_drop5','seurat_Palette_drop1','seurat_Palette_drop6','seurat_Palette_drop4','seurat_Palette_drop2']
