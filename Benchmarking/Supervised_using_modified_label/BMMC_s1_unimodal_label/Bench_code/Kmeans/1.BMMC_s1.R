...
data_name <- paste0('seurat_',c('Palette','Palette_drop1','Palette_drop2','Palette_drop4','Palette_drop5','Palette_drop6'))
meta_name <- c('meta','meta_drop1','meta_drop2','meta_drop4','meta_drop5','meta_drop6')
