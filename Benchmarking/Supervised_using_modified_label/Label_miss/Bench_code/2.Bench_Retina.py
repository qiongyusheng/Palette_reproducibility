...
data_dir = './Benchmarking/Supervised_using_modified_label/Label_miss/output/Retina/'

data_base = ['Palette_s1','Palette_s2','Palette','Palette_s3','Palette_s4']
meta_base = ['meta_s1','meta_s2','meta','meta_s3','meta_s4']
mod = ['_miss5','_miss10','_miss20']
data_name = [d + m for d in data_base for m in mod]
meta_name = [m for m in meta_base for _ in range(3)]

out_dir = './Benchmarking/Supervised_using_modified_label/Label_miss/output/Retina/'
meta_dir = data_dir
