...
data_dir = './Benchmarking/Supervised_using_modified_label/Label_miss/output/TEA_s2/'

data_base = ['Palette_v1','Palette_v2','Palette','Palette_v3','Palette_v4']
meta_base = ['meta','meta','meta','meta','meta']
mod = ['_miss5','_miss10','_miss20']
data_name = [d + m for d in data_base for m in mod]
meta_name = [m for m in meta_base for _ in range(3)]

out_dir = './Benchmarking/Supervised_using_modified_label/Label_miss/output/TEA_s2/'
meta_dir = data_dir
