...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_miss/output/Retina/meta_s1.rds')
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_miss/output/Retina/meta_s2.rds')
cellname <- rownames(meta)
meta <- meta[musa_obj@Meta$cell.name,]
all.equal(musa_obj@Meta$cell.name,rownames(meta))
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_miss/output/Retina/meta.rds')
cellname <- rownames(meta)
meta <- meta[musa_obj@Meta$cell.name,]
all.equal(musa_obj@Meta$cell.name,rownames(meta))
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_miss/output/Retina/meta_s3.rds')
cellname <- rownames(meta)
meta <- meta[musa_obj@Meta$cell.name,]
all.equal(musa_obj@Meta$cell.name,rownames(meta))
...
meta <- readRDS('./Benchmarking/Supervised_using_modified_label/Label_miss/output/Retina/meta_s4.rds')
cellname <- rownames(meta)
meta <- meta[musa_obj@Meta$cell.name,]
all.equal(musa_obj@Meta$cell.name,rownames(meta))
