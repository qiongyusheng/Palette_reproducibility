...
assay_list = list(Batch1=d5,Batch2=d1,Batch3=rbind(d3,d6),Batch4=rbind(d4,d2))
...
write.csv(as.matrix(emb),
          "./Benchmarking/Unsupervised/TEA_s2/output/stab_v1.csv",
          row.names = FALSE)
...
assay_list = list(Batch1=rbind(d3,d1),Batch2=d5,Batch3=rbind(d4,d6),Batch4=d2)
mosaicDataUpSet(assay_list, plot = F)
...
write.csv(as.matrix(emb),
          "./Benchmarking/Unsupervised/TEA_s2/output/stab_v2.csv",
          row.names = FALSE)
...
rna.list <- rna.list[2:3]
adt.list <- adt.list[3:4]
...
assay_list = list(Batch1=d1,Batch2=rbind(d2,d3),Batch3=rbind(d4,d5),Batch4=d6)
mosaicDataUpSet(assay_list, plot = F)
...
write.csv(as.matrix(emb),
          "./Benchmarking/Unsupervised/TEA_s2/output/stab.csv",
          row.names = FALSE)
...
assay_list = list(Batch1=rbind(d3,d1),Batch2=rbind(d4,d5),Batch3=d2,Batch4=d6)
mosaicDataUpSet(assay_list, plot = F)
...
write.csv(as.matrix(emb),
          "./Benchmarking/Unsupervised/TEA_s2/output/stab_v3.csv",
          row.names = FALSE)
...
assay_list = list(Batch1=rbind(d3,d1),Batch2=d2,Batch3=d5,Batch4=rbind(d4,d6))
mosaicDataUpSet(assay_list, plot = F)
...
write.csv(as.matrix(emb),
          "./Benchmarking/Unsupervised/TEA_s2/output/stab_v4.csv",
          row.names = FALSE)