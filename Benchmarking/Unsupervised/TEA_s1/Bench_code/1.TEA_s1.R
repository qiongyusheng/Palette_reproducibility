...
setwd('./Benchmarking/Unsupervised/TEA_s1/output/random1')
...
setwd('./Benchmarking/Unsupervised/TEA_s1/output/random2')
...
setwd('./Benchmarking/Unsupervised/TEA_s1/output/random3')
...
setwd('./Benchmarking/Unsupervised/TEA_s1/output/random4')
...
setwd('./Benchmarking/Unsupervised/TEA_s1/output/random5')
