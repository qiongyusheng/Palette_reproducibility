...
path = ['CITE/s1d1_cite','CITE/s1d3_cite','Multiome/s1d1_multi','Multiome/s1d2_multi','Multiome/s1d3_multi']
...
latent_df.to_csv('./Benchmarking/Unsupervised/BMMC_s1/output/scVAEIT_drop2.csv', index=False)