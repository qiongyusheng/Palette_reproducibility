...
path1 = './Benchmarking/Unsupervised/Ab-seq/output/random1/'
path2 = './Benchmarking/Unsupervised/Ab-seq/output/random1/'

out_dir = './Benchmarking/Unsupervised/Ab-seq/output/random1/'
meta_dir = './Benchmarking/Unsupervised/Ab-seq/output/random1/'

method_mapping = { "Palette":"Palette_s1",
                  'Multigrate':'Multigrate_s1',
                  'scMoMaT':'scMoMaT_s1',
                  'MIDAS':'midas',
                  'scVAEIT':'scVAEIT_s1',
                  "StabMap":"stab_s1"}
...
meta = pyreadr.read_r(meta_dir + "meta_s1.rds")
meta = meta[None]
...
r_df = pyreadr.read_r(out_dir + "lisi_score_s1.rds")[None]
...
latent_df.to_csv(out_dir + 'metrics_s1.csv', index=True)
...
path1 = './Benchmarking/Unsupervised/Ab-seq/output/random2/'
path2 = './Benchmarking/Unsupervised/Ab-seq/output/random2/'

out_dir = './Benchmarking/Unsupervised/Ab-seq/output/random2/'
meta_dir = './Benchmarking/Unsupervised/Ab-seq/output/random2/'

method_mapping = { "Palette":"Palette_s2",
                  'Multigrate':'Multigrate_s2',
                  'scMoMaT':'scMoMaT_s2',
                  'MIDAS':'midas_s2',
                  'scVAEIT':'scVAEIT_s2',
                  "StabMap":"stab_s2"}
...
meta = pyreadr.read_r(meta_dir + "meta_s2.rds")
meta = meta[None]
# dataset = dataset[None]
dataset = np.random.rand(meta.shape[0], 50)
adata = anndata.AnnData(X=dataset, obs=meta)
...
r_df = pyreadr.read_r(out_dir + "lisi_score_s2.rds")[None]
if metric_df.index.equals(r_df.index):
    metric_df['CiLISI'] = r_df['CiLISI']
else:
    r_df2 = r_df.reindex(metric_df.index)
...
latent_df.to_csv(out_dir + 'metrics_s2.csv', index=True)
...
path1 = './Benchmarking/Unsupervised/Ab-seq/output/random3/'
path2 = './Benchmarking/Unsupervised/Ab-seq/output/random3/'

out_dir = './Benchmarking/Unsupervised/Ab-seq/output/random3/'
meta_dir = './Benchmarking/Unsupervised/Ab-seq/output/random3/'

method_mapping = { "Palette":"Palette_s3",
                  'Multigrate':'Multigrate_s3',
                  'scMoMaT':'scMoMaT_s3',
                  'MIDAS':'midas_s3',
                  'scVAEIT':'scVAEIT_s3',
                  "StabMap":"stab_s3"}
...
meta = pyreadr.read_r(meta_dir + "meta_s3.rds")
meta = meta[None]
# dataset = dataset[None]
dataset = np.random.rand(meta.shape[0], 50)
adata = anndata.AnnData(X=dataset, obs=meta)
...
r_df = pyreadr.read_r(out_dir + "lisi_score_s3.rds")[None]
if metric_df.index.equals(r_df.index):
    metric_df['CiLISI'] = r_df['CiLISI']
else:
    r_df2 = r_df.reindex(metric_df.index)
...
latent_df.to_csv(out_dir + 'metrics_s3.csv', index=True)
...
path1 = './Benchmarking/Unsupervised/Ab-seq/output/random4/'
path2 = './Benchmarking/Unsupervised/Ab-seq/output/random4/'

out_dir = './Benchmarking/Unsupervised/Ab-seq/output/random4/'
meta_dir = './Benchmarking/Unsupervised/Ab-seq/output/random4/'
...
path1 = './Benchmarking/Unsupervised/Ab-seq/output/random5/'
path2 = './Benchmarking/Unsupervised/Ab-seq/output/random5/'

out_dir = './Benchmarking/Unsupervised/Ab-seq/output/random5/'
meta_dir = './Benchmarking/Unsupervised/Ab-seq/output/random5/'

method_mapping = { "Palette":"Palette_s4",
                  'Multigrate':'Multigrate_s4',
                  'scMoMaT':'scMoMaT_s4',
                  'MIDAS':'midas_s4',
                  'scVAEIT':'scVAEIT_s4',
                  "StabMap":"stab_s4"}
...
meta = pyreadr.read_r(meta_dir + "meta_s4.rds")
meta = meta[None]
# dataset = dataset[None]
dataset = np.random.rand(meta.shape[0], 50)
adata = anndata.AnnData(X=dataset, obs=meta)
...
r_df = pyreadr.read_r(out_dir + "lisi_score_s4.rds")[None]
if metric_df.index.equals(r_df.index):
    metric_df['CiLISI'] = r_df['CiLISI']
else:
    r_df2 = r_df.reindex(metric_df.index)
...
latent_df.to_csv(out_dir + 'metrics_s4.csv', index=True)