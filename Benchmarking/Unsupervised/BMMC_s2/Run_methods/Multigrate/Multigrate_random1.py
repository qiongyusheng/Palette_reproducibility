...
adata_combined = ad.concat([atacs[5],atacs[7],atacs[9]], axis=0)
# peak = pd.read_csv(os.path.join(dir, path[0] + "/peak.csv"))
adata_combined.var_names = peak_name
...
peak.to_csv('/home/server/sqy/data/mosaic/result/bench/BMMC_s/predict/multigrate/peak.csv', index=False)

adata_hvg5 = adata_hvg[adata_combined.obs['samplename'] == 'batch5',:]
adata_hvg7 = adata_hvg[adata_combined.obs['samplename'] == 'batch7',:]
adata_hvg9 = adata_hvg[adata_combined.obs['samplename'] == 'batch9',:]
...
# 保存为 CSV 文件
latent_df.to_csv('./Benchmarking/Unsupervised/BMMC_s2/output/Multigrate_34.csv', index=False)