...
adata_combined = sc.concat([atacs[5], atacs[7], atacs[9]], join='inner')
...
adata_hvg5 = adata_hvg[adata_combined.obs['samplename'] == s_name[5],:]
adata_hvg7 = adata_hvg[adata_combined.obs['samplename'] == s_name[7],:]
...
# 保存为 CSV 文件
latent_df.to_csv('./Benchmarking/Unsupervised/BMMC_s2/output/Multigrate_24.csv', index=False)