...
adata_combined = ad.concat([atacs[0],atacs[2],atacs[3],atacs[4],atacs[7]], axis=0)
...
adata_hvg1 = adata_hvg[adata_combined.obs['samplename'] == 'batch2',:]
adata_hvg5 = adata_hvg[adata_combined.obs['samplename'] == 'batch3',:]
adata_hvg6 = adata_hvg[adata_combined.obs['samplename'] == 'batch4',:]
...
# 保存为 CSV 文件
latent_df.to_csv('./Benchmarking/Unsupervised/Retina/output/Multigrate_s3.csv', index=False)