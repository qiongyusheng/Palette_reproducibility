...
adata_combined = ad.concat([atacs[0],atacs[1],atacs[2],atacs[5],atacs[7]], axis=0)
...
adata_hvg5 = adata_hvg[adata_combined.obs['samplename'] == 'batch2',:]
...
# 保存为 CSV 文件
latent_df.to_csv('./Benchmarking/Unsupervised/Retina/output/Multigrate_s2.csv', index=False)