...
adata_combined = ad.concat([atacs[1],atacs[3],atacs[5],atacs[6],atacs[7]], axis=0)
...
adata_hvg0 = adata_hvg[adata_combined.obs['samplename'] == 'batch1',:]
adata_hvg1 = adata_hvg[adata_combined.obs['samplename'] == 'batch3',:]
adata_hvg5 = adata_hvg[adata_combined.obs['samplename'] == 'batch5',:]
adata_hvg6 = adata_hvg[adata_combined.obs['samplename'] == 'batch6',:]
...
# 保存为 CSV 文件
latent_df.to_csv('./Benchmarking/Unsupervised/Retina/output/Multigrate_s4.csv', index=False)