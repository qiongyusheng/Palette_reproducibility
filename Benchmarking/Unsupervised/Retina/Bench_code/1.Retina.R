...
setwd('./Benchmarking/Unsupervised/Retina/output/random1')
...
setwd('./Benchmarking/Unsupervised/Retina/output/random2')
...
setwd('./Benchmarking/Unsupervised/Retina/output/random3')
...
setwd('./Benchmarking/Unsupervised/Retina/output/random4')
...
setwd('./Benchmarking/Unsupervised/Retina/output/random5')
