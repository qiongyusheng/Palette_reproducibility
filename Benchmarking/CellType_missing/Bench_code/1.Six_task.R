...
setwd('./Benchmarking/CellType_missing/output/TEA_s1')
...
setwd('./Benchmarking/CellType_missing/output/TEA_s2')
...
setwd('./Benchmarking/CellType_missing/output/BMMC_s1')
...
setwd('./Benchmarking/CellType_missing/output/BMMC_s2')
...
setwd('./Benchmarking/CellType_missing/output/Retina')
...
setwd('./Benchmarking/CellType_missing/output/Ab-seq')
