...
data_dir = './Benchmarking/Supervised/output/TEA_s1/'
data_name = ['Palette_v1','Palette','Palette_v2','Palette_v3','Palette_v4']
meta_name = ['meta_v1','meta','meta_v2','meta_v3','meta_v4']

out_dir = './Benchmarking/Supervised/output/TEA_s1/'
meta_dir = data_dir

metric_df = pd.DataFrame(np.nan, index=data_name, columns=['KMeans NMI','KMeans ARI','Silhouette label','cLISI','Silhouette batch','iLISI','KBET','Graph connectivity','CkBET','CSAS','CiLISI'])
...
for i in range(len(meta_name)):
    ...
    metric_df.iloc[i, 0:8] = tmp.iloc[0, 0:8].values
...
df.loc['Metric Type'] = ['Bio conservation','Bio conservation','Bio conservation','Bio conservation',
...
data_dir = './Benchmarking/Supervised/output/TEA_s2/'
data_name = ['Palette_v1','Palette_v2','Palette','Palette_v3','Palette_v4']
meta_name = ['meta_v1','meta_v2','meta','meta_v3','meta_v4']
...
data_dir = './Benchmarking/Supervised/output/BMMC_s1/'
data_name = ['Palette_drop5','Palette_drop1','Palette_drop6','Palette_drop4','Palette_drop2']
meta_name = ['meta_drop5','meta_drop1','meta_drop6','meta_drop4','meta_drop2']
...
data_dir = './Benchmarking/Supervised/output/BMMC_s2/'
data_name = ['Palette_34','Palette_35','Palette_36','Palette_24','Palette_26']
meta_name = ['meta_34','meta_35','meta_36','meta_24','meta_26']

out_dir = './Benchmarking/Supervised/output/BMMC_s2/'
meta_dir = data_dir
...
data_dir = './Benchmarking/Supervised/output/Retina/'
data_name = ['Palette_s1','Palette_s2','Palette','Palette_s3','Palette_s4']
meta_name = ['meta_s1','meta_s2','meta','meta_s3','meta_s4']

out_dir = './Benchmarking/Supervised/output/Retina/'
meta_dir = data_dir
...
data_dir = './Benchmarking/Supervised/output/Ab-seq/'
data_name = ['Palette_s1','Palette_s2','Palette_s3','Palette','Palette_s4']
meta_name = ['meta_s1','meta_s2','meta_s3','meta','meta_s4']

out_dir = './Benchmarking/Supervised/output/Ab-seq/'
meta_dir = data_dir
