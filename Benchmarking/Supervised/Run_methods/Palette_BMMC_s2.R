...
all.equal(musa_obj@Meta$cell.name,rownames(mm))
...
saveRDS(mm,paste0(out_dir,'/meta_34.rds'))
...
saveRDS(mm,paste0(out_dir,'/meta_35.rds'))
...
saveRDS(mm,paste0(out_dir,'/meta_36.rds'))
...
saveRDS(mm,paste0(out_dir,'/meta_24.rds'))
...
saveRDS(mm,paste0(out_dir,'/meta_26.rds'))