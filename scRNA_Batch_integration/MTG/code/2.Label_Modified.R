...
meta$label_shuffled5 <- meta$SubClass
meta$label_shuffled10 <- meta$SubClass
meta$label_shuffled20 <- meta$SubClass
...
meta$label_miss5 <- meta$SubClass
meta$label_miss10 <- meta$SubClass
meta$label_miss20 <- meta$SubClass
