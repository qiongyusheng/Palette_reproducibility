...
sys.path.append('/home/server/sqy/code')
...
# Age2rna.csv
Age2rna= denoised_data[batch == 1.,:model.vae.config.dim_input_arr[0]]
...
latent_df.to_csv('./ABseq/predict/scvaeit/Age2rna.csv', index=False)

# Age3adt.csv
Age3adt= denoised_data[batch == 2.,model.vae.config.dim_input_arr[0]:]
...
latent_df.to_csv('./ABseq/predict/scvaeit/Age3adt.csv', index=False)

# BM2adt.csv
BM2adt= denoised_data[batch == 4.,model.vae.config.dim_input_arr[0]:]
...
latent_df.to_csv('./ABseq/predict/scvaeit/BM2adt.csv', index=False)

# BM3rna.csv
BM3rna= denoised_data[batch == 5.,:model.vae.config.dim_input_arr[0]]
...
latent_df.to_csv('./ABseq/predict/scvaeit/BM3rna.csv', index=False)
