...
def load_data_config():
    ...
    if "continual" in o.task:
        o.continual = True
        o.dim_s_query = len(utils.load_toml("../midas/configs/data.toml")[re.sub("_continual", "", o.task)]["s_joint"])
        o.dim_s_ref = len(utils.load_toml("../midas/configs/data.toml")[o.reference]["s_joint"])
    else:
        o.continual = False
    ...
    if o.reference != '' and o.continual == False and o.map_ref == 1:  # map query onto reference for transfer learning
        ...
        data_config_ref = utils.load_toml("../midas/configs/data.toml")[cfg_task_ref]
...
def load_model_config():
    model_config = utils.load_toml("../midas/configs/model.toml")["default"]
    if o.model != "default":
        model_config.update(utils.load_toml("../midas/configs/model.toml")[o.model])
