...
merf_co = np.array(pyreadr.read_r('./MERFISH_ATAC/MERFISH/co50_RF.rds')[None]).T
atac_co = np.array(pyreadr.read_r('./MERFISH_ATAC/ATAC/co50_RF.rds')[None]).T
...
latent_df.to_csv('./Reduced_feat/RF50/maxfuse.csv', index=False)