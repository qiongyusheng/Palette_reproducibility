...
top50 = pyreadr.read_r('./MERFISH_ATAC/RF50.rds')[None]
feat = top50['V1'].tolist()
del top50
...
sc.pp.highly_variable_genes(adata_cm, n_top_genes=50, inplace=False, subset=True)
...
latent_df.to_csv('.Reduced_feat/RF50/uniport.csv', 
                 index=False)