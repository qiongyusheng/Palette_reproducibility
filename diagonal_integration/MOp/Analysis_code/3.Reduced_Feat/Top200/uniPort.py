...
top200 = pyreadr.read_r('./MERFISH_ATAC/RF200.rds')[None]
feat = top200['V1'].tolist()
del top200
...
sc.pp.highly_variable_genes(adata_cm, n_top_genes=200, inplace=False, subset=True)
...
latent_df.to_csv('./Reduced_feat/RF200/uniport.csv', 
                 index=False)