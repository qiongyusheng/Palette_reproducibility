...
top100 = pyreadr.read_r('./MERFISH_ATAC/RF100.rds')[None]
feat = top100['V1'].tolist()
del top100
...
sc.pp.highly_variable_genes(adata_cm, n_top_genes=100, inplace=False, subset=True)
...
latent_df.to_csv('./Reduced_feat/RF100/uniport.csv', 
                 index=False)