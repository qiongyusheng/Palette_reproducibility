...
seurat_res <- run_Seurat(list(rna,cytof),meta = meta,nfeatures = 35,reduction = 'cca',out.npcs = 20)
...
harmony_res <- run_Harmony(list(rna,cytof),meta = meta,nfeatures = 35,out.npcs = 20)
...
fastMNN_res <- run_fastMNN(list(rna,cytof),meta = meta,nfeatures = 35,out.npcs = 20)
