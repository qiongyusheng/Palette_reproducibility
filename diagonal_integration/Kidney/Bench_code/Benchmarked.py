...
out_dir = '/home/server/sqy/data/mosaic/result/weak_link/kidney/'
meta_dir = '/home/server/sqy/data/mosaic/input/Human_kidney/'
...
meta = meta[None]
dataset = np.random.rand(44190, 50)
...
latent_df.to_csv('./kidney/metrics.csv', index=True)
